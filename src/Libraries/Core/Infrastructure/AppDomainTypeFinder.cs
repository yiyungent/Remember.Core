...
namespace Core.Infrastructure
{
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IRemFileProvider _fileProvider;

        #endregion

        #region Ctor

        public AppDomainTypeFinder(IRemFileProvider fileProvider = null)
        {
