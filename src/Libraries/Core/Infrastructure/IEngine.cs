...
namespace Core.Infrastructure
{
    ...
    public interface IEngine
    {
        ...
        void ConfigureServices(IServiceCollection services, IConfiguration configuration, RemConfig config);
        ...
        /// <param name="config">Rem configuration parameters</param>
        void RegisterDependencies(ContainerBuilder containerBuilder, RemConfig config);
    }
}
